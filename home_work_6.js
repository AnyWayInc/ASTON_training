...
//Объявление тэга либо селектора класса или id для того чтобы задать ему стиль после чего раскрывается объектные скобки и там уже перечисляются стили для данного элемента
